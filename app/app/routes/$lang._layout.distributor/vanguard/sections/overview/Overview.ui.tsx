...
import { copyText, formatCurrency } from "../../utils";
  ...
  return (
    <div className="bg-base-800 rounded-lg py-6">
      <div className="flex flex-col md:flex-row gap-5">
        <Card
          title={t("distributor.distributorCode")}
          content={
        ...
        />
        <Card
          title={t("distributor.historicalRevenueShare")}
          content={formatCurrency(data.historicalRevenueShare, {
            floor: true,
            precison: 2,
          })}
          showInfoIcon={true}
          infoTooltip={t("distributor.historicalRevenueShareTooltip")}
        />
        <Card
